...
(function () {
	var superPath = "/vendor/laravel-admin-ext/supermap";
    ...
    function load() {
        ...
        if (!inArray(excludes, 'iclient-leaflet')) {
          if (supportES6()) {
              inputScript(superPath +"/dist/leaflet/iclient-leaflet-es6.min.js");
          } else {
              inputScript(superPath +"/dist/leaflet/iclient-leaflet.min.js");
          }
        }
        if (inArray(includes, 'iclient-leaflet-css')) {
            inputCSS(superPath + "/dist/leaflet/iclient-leaflet.min.css");
        }
        ...
        if (inArray(includes, 'iclient-leaflet-vue')) {
          inputCSS(superPath + "/dist/leaflet/iclient-leaflet-vue.css");
          inputScript(superPath + "/dist/leaflet/iclient-leaflet-vue.min.js");
        }
    }
